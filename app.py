...
# ============================================================
# إخفاء كل عناصر Streamlit و GitHub
# ============================================================
HIDE_STREAMLIT = """
<style>
...
function hideStreamlitElements() {
    const selectors = [
        ...
        '.stDeployButton', '.stActionButton', '[data-testid="stActionButton"]',
        'a[href*="github"]', '[data-testid="stSidebarCollapsedControl"]'
    ];
    ...
    document.querySelectorAll('*').forEach(el => {
        if (el.textContent && el.children.length === 0 &&
            (el.textContent.includes('Made with Streamlit') ||
             el.textContent.includes('Manage app'))) {
            el.style.display = 'none';
        }
    });
}
...
const observer = new MutationObserver(hideStreamlitElements);
