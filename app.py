...
# ============================================================
# تعديل: إجبار اللون الأبيض وإخفاء الشعارات (Hosted by & GitHub)
# ============================================================
FIX_UI_STYLE = """
<style>
    /* 1. إجبار الخلفية على اللون الأبيض والنصوص العامة على الأسود */
    [data-testid="stAppViewContainer"], .stApp {
        background-color: #ffffff !important;
        color: #000000 !important;
    }
    
    /* جعل العناوين والنصوص العادية سوداء */
    .stMarkdown, .stText, p, h1, h2, h3, h4, h5, h6, span {
        color: #262730 !important;
    }

    /* 2. إخفاء الهيدر العلوي بالكامل (يحتوي على GitHub والقائمة) */
    ...
    /* 3. إخفاء شعار Hosted by Streamlit وأزرار Deploy */
    ...
    /* 6. تحسين الحواف العلوية */
    .main .block-container {
        padding-top: 2rem !important;
        max-width: 98% !important;
    }
    
    /* استثناء النصوص داخل البطاقات والبانرات لتبقى ملونة أو بيضاء حسب التصميم */
...
<script>
    function killBranding() {
        const selectors = [
            ...
            '[class*="viewerBadge"]', '.stDeployButton', 'a[href*="github"]'
        ];
        selectors.forEach(sel => {
            document.querySelectorAll(sel).forEach(el => el.remove());
        });
    }
    window.addEventListener('load', killBranding);
    setInterval(killBranding, 500);
</script>
"""
...
<style>
    ...
    /* تنسيق البطاقة السوداء لتظهر بوضوح على الخلفية البيضاء */
    .rec-card {
