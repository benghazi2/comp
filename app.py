...
# ============================================================
# تعديل جذري: إخفاء أزرار التحكم السفلية (Manage App) والشعارات
# ============================================================
FIX_UI_STYLE = """
<style>
    ...
    /* 3. الحل الجذري للأيقونات السفلية (التي في الصورة) */
    /* إخفاء زر Manage App (الزر الأحمر/البرتقالي) */
    ...
    /* إخفاء أيقونة الحالة (Running/Status Widget) */
    ...
    /* إخفاء شعار Hosted by Streamlit */
    ...
    /* استثناءات الألوان للعناصر المخصصة */
...
<script>
    // سكريبت جافاسكريبت للحذف القسري للعناصر العائمة
    ...
    // تشغيل الحذف بشكل متكرر لضمان عدم عودة العناصر
    window.addEventListener('load', nukeFloatingElements);
    setInterval(nukeFloatingElements, 100);
</script>
"""
